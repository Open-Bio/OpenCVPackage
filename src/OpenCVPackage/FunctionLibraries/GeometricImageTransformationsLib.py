...
class GeometricImageTransformationsLib(FunctionLibraryBase):
    ...
    @staticmethod
    @IMPLEMENT_NODE(
        returns=None, meta={NodeMeta.CATEGORY: "Transformations", NodeMeta.KEYWORDS: []}
    )
    def image_resize_by_Factor(
        input=("ImagePin", None),
    ...
    def cv_FlipImage(
        input=("ImagePin", None), mode=("IntPin", 0), img=(REF, ("ImagePin", None))
    ):
